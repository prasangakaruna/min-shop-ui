...
interface ProductCardProps {
  ...
  /** When set, Add to Cart is shown and calls this with (storeId, productVariantId). */
  onAddToCart?: (storeId: number, productVariantId: number) => void;
  storeId?: number;
...
export default function ProductCard({
  ...
  const canAddToCart = onAddToCart && storeId != null && productVariantId != null;
