          ...
          <div className="bg-white rounded-lg shadow-md p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <Link href="/forgot-password" className="text-sm text-mint hover:text-mint-dark">
                  Forgot password?
                </Link>
              </div>
              ...
              <button
                type="submit"
                className="w-full bg-mint text-white py-3 rounded-lg font-medium hover:bg-mint-dark transition-colors"
              >
                Sign In
              </button>
            </form>
            ...
            <div className="text-center">
              <p className="text-gray-600">
                ...
                <Link href="/signup" className="text-mint font-medium hover:text-mint-dark">
                  Sign up
                </Link>
              </p>
            </div>
